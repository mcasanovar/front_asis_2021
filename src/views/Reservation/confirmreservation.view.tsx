...
import { confirmReservationService, getOneReservationService } from '../../services/reservation.services';
          ...
          <Row gutter={8}>
            ...
            <Col span={6}>
              ...
              >
                <Select
                  style={{ width: '100%' }}
                  onSelect={(e: SelectValue) => setNewReservationData({ ...newReservationData, reqEvaluacion: e.toString() })}
                  id='error'
