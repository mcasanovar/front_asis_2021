          ...
          <Row gutter={8}>
            <Col span={5}>
              ...
              >
                <Input
                  readOnly
                  value={`$${MilesFormat(newRequestData.monto_neto)}.-`}
                />
              </Form.Item>
            </Col>
            <Col span={4}>
              ...
              >
                <Input
                  readOnly
                  value={`${MilesFormat(newRequestData.porcentaje_impuesto)}%`}
                />
              </Form.Item>
            </Col>
            <Col span={5}>
              ...
              >
                <Input
                  readOnly
                  value={`$${MilesFormat(newRequestData.valor_impuesto)}.-`}
                />
              </Form.Item>
            </Col>
            <Col span={5}>
              ...
              >
                <Input
                  readOnly
                  value={`$${MilesFormat(newRequestData.exento)}.-`}
                />
              </Form.Item>
            </Col>
            <Col span={5}>
              ...
              >
                <Input
                  readOnly
                  value={`$${MilesFormat(newRequestData.monto_total)}.-`}
                />
              </Form.Item>
            </Col>
          </Row>
          ...
          <Row gutter={8}>
            <Col span={6}>
              ...
              >
                <Input
                  readOnly
                  value={newRequestData.fecha_servicio_solicitado}
                />
              </Form.Item>
            </Col>
            <Col span={6}>
            ...
            <Col span={6}>
              ...
              >
                <Input
                  readOnly
                  value={newRequestData.hora_servicio_solicitado_termino}
                />
              </Form.Item>
            </Col>
          </Row>
