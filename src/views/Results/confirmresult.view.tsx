...
const ConfirmResultView: React.FunctionComponent<IConfirmResultViewProps> = ({
    ...
    const [newDataResult, setNewDataResult] = useState<ResultModel>(
    ...
    const handleConfirmResult = async () => {
        setLoading(true)
        const aux: IResponseResults = await confirmResultService(
            newDataResult._id,
            {
                ...newDataResult,
    ...
    useEffect(() => {
        if (newDataResult.estado_archivo !== '') {
            ...
            if (
                !!newDataResult.estado_resultado &&
                    ...
                    <Row>
                        <Col span={12}>
                            <Input.Group>
                                ...
                                <Row>
                                    <Col span={24}>
                                        <Form.Item label="Condicionantes">
                                            <Select
                                                mode="tags"
                                                onChange={(e: any) =>
                                                    setNewDataResult({
                    ...
                    <Row gutter={8}>
                        ...
                        >
                            <Table
                                style={{ width: '100%' }}
                                showHeader={true}
                                dataSource={resultSelected?.observaciones}
                                pagination={false}
                            >
                                <Column
                                    width="20%"
