          ...
          <Row>
            <Col span={12}>
              <Input.Group>
                <Row gutter={8}>
                  <Col span={12}>
                    ...
                    >
                      <Input
                        readOnly
                        value={newDataResult.estado_archivo}
                      />
                    </Form.Item>
                  </Col>
                  <Col span={12}>
                ...
                <Row gutter={8}>
                  <Col span={8}>
                    ...
                    >
                      <Input
                        readOnly
                        value={newDataResult.vigencia_examen}
                      />
                    </Form.Item>
                  </Col>
                  <Col span={8}>
                    ...
                    >
                      <Input
                        readOnly
                        value={newDataResult.fecha_resultado}
                      />
                    </Form.Item>
                  </Col>
                  <Col span={8}>
                    ...
                    >
                      <Input
                        readOnly
                        value={newDataResult.hora_resultado}
                      />
                    </Form.Item>
                  </Col>
                </Row>
                ...
                <Row>
                  <Col span={24}>
                    {newDataResult.observaciones.length > 0 && newDataResult.observaciones.map((obs, index) => (
