    ...
    return (
      <Form layout='vertical'>
        <Input.Group>
          ...
          <Row>
            <Col span={24}>
              <Paragraph style={{ fontWeight: 'bold' }}>Adecuación a las normas</Paragraph>
            </Col>
          </Row>
          <Row gutter={8}>
            <Col span={8}>
          ...
          <Row>
            <Col span={24}>
              <Paragraph style={{ fontWeight: 'bold' }}>Actitud a la prevensión de los riesgos</Paragraph>
            </Col>
          </Row>
          <Row gutter={8}>
            <Col span={8}>
          ...
          <Row>
            <Col span={24}>
              <Paragraph style={{ fontWeight: 'bold' }}>Motivación por el cargo</Paragraph>
            </Col>
          </Row>
          <Row gutter={8}>
            <Col span={8}>
