...
const DetailsRequestPaymentView: React.FunctionComponent<IDetailsRequestPaymentViewProps> = ({
  onCloseModal,
  requestpaymentSelected
}) => {
  ...
  return (
    <Form layout='vertical' >
      ...
      { <Title level={4}>{`${requestpaymentSelected?.nombre_servicio} - ${requestpaymentSelected?.codigo}`}</Title>}
      <br />
      <Input.Group>
        <Row gutter={8}>
          <Col span={12}>
        ...
        <Row gutter={8}>
          <Col span={8}>
            ...
            >
              <Input
                readOnly
                value={requestpaymentSelected?.faena_seleccionada_cp}
              />
            </Form.Item>
          </Col>
          <Col span={16}>
        ...
        <Row gutter={8}>
          <Col span={8}>
            ...
            >
              <Input
                readOnly
                value={requestpaymentSelected?.fecha_facturacion}
              />
            </Form.Item>
          </Col>
          <Col span={8}>
        ...
        <Row gutter={8}>
          <Col span={8}>
            ...
            >
              <Input
                readOnly
                value={`$ ${MilesFormat(requestpaymentSelected?.valor_servicio || 0)}`}
              />
            </Form.Item>
          </Col>
          <Col span={8}>
            ...
            >
              <Input
                readOnly
                value={`$ ${MilesFormat(requestpaymentSelected?.valor_deuda || 0)}`}
              />
            </Form.Item>
          </Col>
          <Col span={8}>
            ...
            >
              <Input
                readOnly
                value={`$ ${MilesFormat(requestpaymentSelected?.valor_cancelado || 0)}`}
              />
            </Form.Item>
          </Col>
        </Row>
