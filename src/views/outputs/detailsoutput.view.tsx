        ...
        <Row gutter={8}>
          ...
          <Col span={4}>
            ...
            >
              <Input
                readOnly
                value={`$ ${MilesFormat(outputSelected?.costo_unitario || 0)}`}
              />
            </Form.Item>
          </Col>
          <Col span={4}>
            ...
            >
              <Input
                readOnly
                value={`$ ${MilesFormat(outputSelected?.costo_total || 0)}`}
              />
            </Form.Item>
          </Col>
          <Col span={4}>
            ...
            >
              <Input
                readOnly
                value={`$ ${MilesFormat(outputSelected?.precio_venta_unitario || 0)}`}
              />
            </Form.Item>
          </Col>
          <Col span={4}>
            ...
            >
              <Input
                readOnly
                value={`$ ${MilesFormat(outputSelected?.ingreso_total || 0)}`}
              />
            </Form.Item>
          </Col>
        </Row>
