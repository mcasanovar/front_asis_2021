                ...
                <Row gutter={8}>
                    <Col span={12}>
                        <Form.Item label="Código">
                            <Input readOnly value={paymentSelected?.codigo} />
                        </Form.Item>
                    </Col>
                    <Col span={12}>
                        <Form.Item label="Estado proceso">
                            <Input readOnly value={paymentSelected?.estado} />
                        </Form.Item>
                    </Col>
                </Row>
                <Row gutter={8}>
                    <Col span={4}>
                        <Form.Item label="Rut CP">
                            <Input readOnly value={paymentSelected?.rut_cp} />
                        </Form.Item>
                    </Col>
                    <Col span={8}>
                    ...
                    <Col span={4}>
                        <Form.Item label="Rut CS">
                            <Input readOnly value={paymentSelected?.rut_cs} />
                        </Form.Item>
                    </Col>
                    <Col span={8}>
                ...
                <Row gutter={8}>
                    <Col span={12}>
                        <Form.Item label="Sucursal">
                            <Input readOnly value={paymentSelected?.sucursal} />
                        </Form.Item>
                    </Col>
                    <Col span={12}>
