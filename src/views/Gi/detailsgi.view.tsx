...
const DetailsGIView: React.FunctionComponent<IDetailsGIViewProps> = ({
  ...
  useEffect(() => {
    if (newGiData._id !== '' && countries.length > 0) {
      setLoading(false);
      const aux = countries.find((country: ICountries) => country.alpha3Code === newGiData.pais_origen);
      if (!aux) return
              ...
              <Row gutter={8}>
                <Col span={12}>
                  ...
                  >
                    <Input
                      readOnly
                      value={newGiData.razon_social_org_perteneciente}
                    />
                  </Form.Item>
                </Col>
                <Col span={12}>
              ...
              <Row gutter={8}>
                <Col span={8}>
                  ...
                  >
                    <Input
                      readOnly
                      value={newGiData.fecha_vencimiento_ci}
                    />
                  </Form.Item>
                </Col>
                <Col span={8}>
                  ...
                  <>
                    ...
                    <Col span={6}>
                      ...
                      >
                        <Input
                          readOnly
                          value={newGiData.fecha_venc_licencia}
                        />
                      </Form.Item>
                    </Col>
                    <Col span={4}>
          ...
          {newGiData.categoria === 'Empresa/Organizacion' &&
            <>
              <Row gutter={8}>
                <Col span={8}>
                  <Form.Item
                    label='Grado de formalización'
                  >
                    <Input
                      readOnly
                      value={newGiData.grado_formalizacion}
                    />
                  </Form.Item>
                </Col>
              </Row>
