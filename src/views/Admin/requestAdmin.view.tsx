...
import { getGIByRutService, getRequestsByCode, getWorkersGIService, updateRequestAdmin } from '../../services';
...
const ResquestAdminView: React.FunctionComponent<IRequestAdminViewProps> = ({ authorized }) => {
  ...
  const handleSetContractNumber = (nro: string) => {
    setNewRequestData({ ...newRequestData, nro_contrato_seleccionado_cp: nro });
    const aux = primaryClient?.contrato_faenas.find((contract: IContract) => contract.nro_contrato === nro);
    if (!aux) return
  ...
  return (
    <div className="container-gi">
      ...
      <Spin spinning={loading} size='large' tip='Cargando...'>
        ...
        <br />
        <br />
        <Collapse accordion defaultActiveKey={['1']} style={{ minWidth: 1100 }}>
