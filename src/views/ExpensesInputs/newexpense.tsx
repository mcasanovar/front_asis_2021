...
const ExpensesView: React.FunctionComponent<IExpensesProps> = ({
    ...
    const [newDataExpense, setNewDataExpense] = useState<ExpensesModel>(
        ExpensesInitialization
    )
        ...
        setNewDataExpense({
            ...
            subcategoria_dos:
                CATEGORIES_EXPENSES[indexsubone].subcategoria_uno[indexsubtwo]
                    .subcategoria_dos[index].subcategoria_dos,
            inventario: CATEGORIES_EXPENSES[indexsubone].subcategoria_uno[
                indexsubtwo
            ].subcategoria_dos[index].inventario
                ? 'Si'
                : 'No',
        })
    }
            ...
            <Form layout="vertical">
                <Input.Group>
                                ...
                                >
                                    {suppliers.map(supplier => (
                                        <Option
                                            key={supplier._id}
                                            value={supplier._id}
                                        >{`${supplier.rut} - ${supplier.razon_social}`}</Option>
                                    ))}
                                </Select>
                            </Form.Item>
                        </Col>
                    ...
                    {newDataExpense.requiere_servicio === 'Si' && (
                        <Row>
                            <Col span={8}>
                                <Form.Item label="Servicio asociado">
                                    <Select
                                        showSearch
                                        optionFilterProp="children"
                                    ...
                                    >
                                        {requests.map(request => (
                                            <Option
                                                key={request._id}
                                                value={request._id}
                                            >{`${request.codigo} - ${request.nombre_servicio}`}</Option>
                                        ))}
                                    </Select>
                                </Form.Item>
                            </Col>
                    ...
                    <Row>
                        <Col span={24}>
                            <Form.Item label="Descripción gasto">
                                <TextArea
                                    rows={3}
                                    onChange={e =>
                                        setNewDataExpense({
