            ...
            <Form layout="vertical">
                <Input.Group>
                    <Row gutter={8}>
                        ...
                        <Col span={12}>
                            <Form.Item label="Institución bancaria">
                                <Input
                                    readOnly
                                    value={
                                        expenseSelected?.institucion_bancaria
                                    }
                                />
                            </Form.Item>
                        </Col>
                    ...
                    <Row gutter={8}>
                        <Col span={6}>
                            <Form.Item label="Cantidad / factor">
                                <Input
                                    readOnly
                        ...
                        <Col span={6}>
                            <Form.Item label="Precio unitario">
                                <Input
                                    readOnly
                                    value={`$${MilesFormat(
                                        expenseSelected?.precio_unitario || 0
                                    )}`}
                                />
                            </Form.Item>
                        </Col>
