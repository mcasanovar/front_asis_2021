...
const DetailsExistenceView: React.FunctionComponent<
    IDetailsExistenceViewProps
> = ({ onCloseModal, existenceSelected }) => {
        ...
        <Form layout="vertical">
            {
                <Title
                    level={4}
                >{`${existenceSelected?.codigo_categoria_tres} - ${existenceSelected?.subcategoria_tres}`}</Title>
            }
            <br />
            <Input.Group>
                <Row gutter={8}>
                    ...
                    <Col span={6}>
                        <Form.Item label="Subcategoria 1">
                            <Input
                                readOnly
                    ...
                    <Col span={6}>
                        <Form.Item label="Subcategoria 2">
                            <Input
                                readOnly
                    ...
                    <Col span={6}>
                        <Form.Item label="Subcategoria 3">
                            <Input
                                readOnly
                ...
                <Row gutter={8}>
                    ...
                    <Col span={4}>
                        <Form.Item label="Costo unitario promedio">
                            <Input
                                readOnly
                                value={`$ ${MilesFormat(
                                    existenceSelected?.costo_unitario_promedio ||
                                        0
                                )}`}
                            />
                        </Form.Item>
                    ...
                    <Col span={4}>
                        <Form.Item label="Costo total">
                            <Input
                                readOnly
                                value={`$ ${MilesFormat(
                                    existenceSelected?.costo_total || 0
                                )}`}
                            />
                        </Form.Item>
                    </Col>
                ...
                <Row>
                    <Col span={4}>
                        <Form.Item label="Estado">
                            <Input readOnly value={existenceSelected?.estado} />
                        </Form.Item>
                    </Col>
                </Row>
            </Input.Group>
