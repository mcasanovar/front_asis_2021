...
const UploadGroupInvoicesView: React.FunctionComponent<
    IUploadGroupInvoicesViewProps
> = ({ onCloseModal, company }) => {
    ...
    const [dataConfirmation, setDataConfirmation] =
        useState<IGroupUploadInvoices>(IGroupUploadInvoicesInitialization)
    ...
    const handleGroupUploadInvoices = async () => {
        ...
        const aux: IResponseInvoices = await uploadGroupInvoicesService(
            formData
        )
        if (!aux.err) {
        ...
        if (!aux.err) {
            const filteredInvoices = aux.res.filter(
                (invoice: InvoicesModel) =>
                    invoice.estado_archivo === 'Aprobado' ||
                    invoice.estado_archivo === 'Rechazado' ||
                    invoice.estado_archivo === 'Sin Documento'
            )
    ...
    useEffect(() => {
        if (
            !!dataConfirmation.fecha_facturacion &&
                    ...
                    <Row gutter={8}>
                            ...
                            >
                                <InputNumber
                                    ...
                                    onChange={e =>
                                        setDataConfirmation({
                                            ...dataConfirmation,
                                            monto_neto: parseInt(e.toString()),
                                        })
                                    }
                        ...
                        <Col span={8}>
                            <Form.Item
                                ...
                                validateStatus={
                                    !!dataConfirmation.porcentaje_impuesto
                                        ? 'success'
                                        : 'error'
                                }
                                help={
    ...
    return (
        <Spin spinning={loading} size="large" tip="Cargando...">
            ...
            <Form layout="vertical">
                <Input.Group>
                    <Row gutter={8}>{renderInformation()}</Row>
                    <br />
                    <Row
                        gutter={8}
                        style={{
                    ...
                    >
                        ...
                        >
                            <Checkbox
                                ...
                                onChange={() =>
                                    setCheckRutFilter(!checkRutFilter)
                                }
                        ...
                        >
                            ...
                            <Form.Item label="Buscar por Fecha Resultado">
                                <RangePicker
                                    ...
                                    disabled={
                                        checkRangeDateFilter ? false : true
                                    }
                                />
                            </Form.Item>
                        </Col>
