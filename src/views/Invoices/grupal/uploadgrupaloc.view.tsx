...
const UploadGrupalOCView: React.FunctionComponent<IUploadGrupalOCViewProps> = ({
    ...
    const [dataConfirmation, setDataConfirmation] = useState<IGroupUploadOC>(
        IGroupUploadOCInitialization
    )
                ...
                <Row gutter={8}>
                    <Col span={12}>
                        <Form.Item
                            label="Numero OC"
                            validateStatus={
                                !!dataConfirmation.nro_oc ? 'success' : 'error'
                            }
                            help={
                                !!dataConfirmation.nro_oc
                                    ? ''
                    ...
                    <Col span={6}>
                        <Form.Item label="Fecha subida OC">
                            <DatePicker
                                style={{ width: '100%' }}
                                format={FORMAT_DATE}
                    ...
                    <Col span={6}>
                        <Form.Item label="Hora subida OC">
                            <TimePicker
                                style={{ width: '100%' }}
                                format="HH:mm"
                        ...
                        <Form.Item label="Observaciones">
                            <TextArea
                                ...
                                onChange={e =>
                                    setDataConfirmation({
                                        ...dataConfirmation,
                                        observacion_oc: e.currentTarget.value,
                                    })
                                }
                    ...
                    <Col span={2}>
                        <Form.Item label=".">
                            <Button
                                ...
                                style={{
                                    backgroundColor: checkRangeDateFilter
                                        ? '#E10D17'
                                        : 'gray',
                                    color: 'white',
                                }}
