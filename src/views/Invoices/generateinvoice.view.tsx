...
const GenerateInvoice: React.FunctionComponent<IGenerateInvoiceProps> = ({
    ...
    const [newDataInvoice, setNewDataInvoice] = useState<InvoicesModel>(
        invoiceSelected || InvoicesInitialization
    )
    ...
    const handleGenerateInvoice = async () => {
        ...
        const result: IResponseInvoices = await generateInvoiceService(
            newDataInvoice._id,
            formData
        )
        if (result.err === null) {
    ...
    useEffect(() => {
        if (!!companyBusinessName && !!newDataInvoice.fecha_facturacion) {
                ...
                <Row gutter={8}>
                    <Col span={6}>
                        <Form.Item label="Código">
                            <Input readOnly value={newDataInvoice.codigo} />
                        </Form.Item>
                    </Col>
                    <Col span={6}>
                        <Form.Item label="Sucursal">
                            <Input readOnly value={newDataInvoice.sucursal} />
                        </Form.Item>
                    </Col>
                    <Col span={12}>
                ...
                <Row gutter={8}>
                    <Col span={4}>
                        <Form.Item label="Rut CP">
                            <Input readOnly value={newDataInvoice.rut_cp} />
                        </Form.Item>
                    </Col>
                    <Col span={8}>
                    ...
                    <Col span={4}>
                        <Form.Item label="Rut CS">
                            <Input readOnly value={newDataInvoice.rut_cs} />
                        </Form.Item>
                    </Col>
                    <Col span={8}>
                ...
                <Row gutter={8}>
                    <Col span={12}>
                        <Form.Item label="Representante">
                            <Input readOnly value={company?.nombre} />
                        </Form.Item>
                    </Col>
                    <Col span={12}>
                        <Form.Item
                            validateStatus={
                                companyBusinessName !== '' ? 'success' : 'error'
                            }
                            help={
                                companyBusinessName !== '' ? '' : 'Seleccione'
                            }
                            label="Razon social"
                        >
                            <Select
                                ...
                                <Col span={12}>
                                    <Form.Item label="Porcentaje IVA">
                                        <InputNumber
                                            ...
                                            value={
                                                newDataInvoice.porcentaje_impuesto
                                            }
                                        />
                                    </Form.Item>
                                </Col>
                                <Col span={12}>
                                    <Form.Item label="Total IVA">
                                        <InputNumber
                                            style={{ width: '100%' }}
                                            readOnly
                                            formatter={value =>
                                ...
                                <Col span={12}>
                                    <Form.Item label="Exento">
                                        <InputNumber
                                            ...
                                            onChange={e =>
                                                handleSumExentoAndDcto(
                                                    parseInt(e.toString()),
                                                    newDataInvoice.descuento
                                                )
                                            }
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <p className="ant-upload-text">
                                            Click o arrastra el archivo para
                                            subirlo
                                        </p>
    ...
    return (
        <Spin spinning={loading} size="large" tip="Cargando...">
            ...
            )}
            {
                <Title
                    level={4}
                >{`${newDataInvoice.nombre_servicio} - ${newDataInvoice.codigo}`}</Title>
            }
