...
const DetailsInvoicesView: React.FunctionComponent<
    IDetailsInvoicesViewProps
> = ({ onCloseModal, onDownloadOC, invoiceSelected, company }) => {
    ...
    const handleGetOCState = () => {
        const aux =
            invoiceSelected?.observacion_oc[
                invoiceSelected?.observacion_oc.length - 1
            ]
        return aux?.estado || ''
    }
    ...
    const handleGetInvoiceState = () => {
        const aux =
            invoiceSelected?.observacion_factura[
                invoiceSelected.observacion_factura.length - 1
            ]
        return aux?.estado || ''
    }
    ...
    const renderInvoiceInformation = () => {
        return (
            <Form layout="vertical">
                ...
                <Row gutter={8}>
                    <Col span={6}>
                        <Form.Item label="Código facturación">
                            <Input readOnly value={invoiceSelected?.codigo} />
                        </Form.Item>
                    </Col>
                    <Col span={6}>
                        <Form.Item label="Sucursal">
                            <Input readOnly value={invoiceSelected?.sucursal} />
                        </Form.Item>
                    </Col>
                    <Col span={12}>
                ...
                <Row gutter={8}>
                    <Col span={4}>
                        <Form.Item label="Rut CP">
                            <Input readOnly value={invoiceSelected?.rut_cp} />
                        </Form.Item>
                    </Col>
                    <Col span={8}>
                    ...
                    <Col span={4}>
                        <Form.Item label="Rut CS">
                            <Input readOnly value={invoiceSelected?.rut_cs} />
                        </Form.Item>
                    </Col>
                    <Col span={8}>
                ...
                <Row gutter={8}>
                    ...
                    <Col span={12}>
                        <Form.Item label="Razon social empresa">
                            <Input
                                readOnly
                    ...
                    <Col span={16}>
                        <Input.Group>
                            <Row gutter={8}>
                                <Col span={8}>
                                    <Form.Item label="Fecha factura">
                                        <Input
                                            readOnly
                                            value={
                                                invoiceSelected?.fecha_facturacion
                                            }
                                        />
                                    </Form.Item>
                                </Col>
                                ...
                                <Col span={8}>
                                    <Form.Item label="Orden de compra (OC)">
                                        <Input
                                            readOnly
                                            value={invoiceSelected?.nro_oc}
                                        />
                                ...
                                <Col span={12}>
                                    <Form.Item label="IVA">
                                        <Input
                                            readOnly
                                            value={`$ ${MilesFormat(
                                                invoiceSelected?.valor_impuesto ||
                                                    0
                                            )}`}
                                        />
                                    </Form.Item>
                ...
                <Row>
                    ...
                    >
                        <Table
                            style={{ width: '100%' }}
                            showHeader={true}
                            dataSource={invoiceSelected?.observacion_factura}
                            pagination={false}
                        >
                            <Column
                                width="20%"
