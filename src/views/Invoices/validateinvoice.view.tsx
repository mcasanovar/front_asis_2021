...
const ValidateInvoiceView: React.FunctionComponent<
    IValidateInvoiceViewProps
> = ({ onCloseModal, invoiceSelected }) => {
    ...
    const handleConfirmInvoice = async () => {
        ...
        const aux: IResponseInvoices = await confirmInvoiceService(
            invoiceSelected?._id || '',
            invoiceMapped
        )
        if (aux.err === null) {
                                        ...
                                        <Col span={8}>
                                            ...
                                            >
                                                <Input
                                                    ...
                                                    value={
                                                        newDataInvoice.nro_nota_credito
                                                    }
                                                    id="error_2"
                                                />
                                            </Form.Item>
                    ...
                    >
                        ...
                        <Column
                            ...
                            render={(_, record: any) => {
                                ...
                                return (
                                    <>
                                        <Tag color={color}>{record.estado}</Tag>
                                    </>
                                )
                            }}
                        />
