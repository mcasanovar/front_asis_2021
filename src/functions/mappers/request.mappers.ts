...
const MapRequestToInsert = (
    ...
    return {
        ...restOfData,
        fecha_solicitud: moment(request.fecha_solicitud, FORMAT_DATE).format(
            FORMAT_DATE
        ),
        sendMail,
        emailsArray,
...
const MapGroupRequestsToConfirm = (
    data: IDataConfirmation,
    selectedKeyRequests: React.Key[]
) => {
    const aux = [
        {
            ...data,
