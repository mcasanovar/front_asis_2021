...
const MapAversionToCreateExam = (
    ...
    return {
        ...
        fecha_evaluacion:
            moment(evaluation?.fecha_evaluacion, `${FORMAT_DATE} HH:mm`).format(
                FORMAT_DATE
...
const MapPsicoToCreateExam = (
    ...
    return {
        ...
        obs_examen_psicotecnico:
            psico.obs_examen_psicotecnico !== ''
                ? psico.obs_examen_psicotecnico
                : 'Sin Observaciones',
        obs_examen_sensometrico:
            psico.obs_examen_sensometrico !== ''
                ? psico.obs_examen_sensometrico
                : 'Sin Observaciones',
        obs_evaluacion_somnolencia:
            psico.obs_evaluacion_somnolencia !== ''
                ? psico.obs_evaluacion_somnolencia
                : 'Sin Observaciones',
        obs_evaluacion_psicologica:
            psico.obs_evaluacion_psicologica !== ''
                ? psico.obs_evaluacion_psicologica
                : 'Sin Observaciones',
        obs_test_velocidad_anticipacion:
            psico.obs_test_velocidad_anticipacion !== ''
                ? psico.obs_test_velocidad_anticipacion
                : 'Sin Observaciones',
        obs_test_tolerancia_monotonia:
            psico.obs_test_tolerancia_monotonia !== ''
                ? psico.obs_test_tolerancia_monotonia
                : 'Sin Observaciones',
        obs_test_reacciones_multiples:
            psico.obs_test_reacciones_multiples !== ''
                ? psico.obs_test_reacciones_multiples
                : 'Sin Observaciones',
        obs_evaluacion_transito_nacional:
            psico.obs_evaluacion_transito_nacional !== ''
                ? psico.obs_evaluacion_transito_nacional
                : 'Sin Observaciones',
        restricciones:
            psico.restricciones !== ''
