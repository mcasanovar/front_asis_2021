...
const TableComponent: React.FunctionComponent<ITableComponentProps> = ({
    ...
    const handleShowDeletePermission = (type: string) => {
        switch (type) {
            case 'gi':
                return userPermissions.indexOf(PERMISSIONS.DELETE_GI) > -1
                    ? true
                    : false
            case 'employees':
                return userPermissions.indexOf(PERMISSIONS.DELETE_EMPLOYEE) > -1
                    ? true
                    : false
            case 'invoices':
                return userPermissions.indexOf(PERMISSIONS.DELETE_INVOICE) > -1
                    ? true
                    : false
            case 'payments':
                return userPermissions.indexOf(PERMISSIONS.DELETE_PAYMENT) > -1
                    ? true
                    : false
            case 'expenses':
                return userPermissions.indexOf(PERMISSIONS.DELETE_EXPENSE) > -1
                    ? true
                    : false
            default:
                return false
    ...
    const handleShowDetailsPermission = (type: string) => {
        switch (type) {
            case 'gi':
                return userPermissions.indexOf(PERMISSIONS.DETAILS_GI) > -1
                    ? true
                    : false
            case 'employees':
                return userPermissions.indexOf(PERMISSIONS.DETAILS_EMPLOYEE) >
                    -1
                    ? true
                    : false
            case 'requests':
                return userPermissions.indexOf(PERMISSIONS.DETAILS_REQUETS) > -1
                    ? true
                    : false
            case 'reservations':
                return userPermissions.indexOf(
                    PERMISSIONS.DETAILS_RESERVATION
                ) > -1
                    ? true
                    : false
            case 'evaluations':
                return userPermissions.indexOf(PERMISSIONS.DETAILS_EVALUATION) >
                    -1
                    ? true
                    : false
            case 'results':
                return userPermissions.indexOf(PERMISSIONS.DETAILS_RESULT) > -1
                    ? true
                    : false
            case 'invoices':
                return userPermissions.indexOf(PERMISSIONS.DETAILS_INVOICE) > -1
                    ? true
                    : false
            case 'payments':
                return userPermissions.indexOf(PERMISSIONS.DETAILS_PAYMENT) > -1
                    ? true
                    : false
            case 'requestPayments':
                return userPermissions.indexOf(
                    PERMISSIONS.DETAILS_REQUESTPAYMENT
                ) > -1
                    ? true
                    : false
            case 'expenses':
                return userPermissions.indexOf(PERMISSIONS.DETAILS_EXPENSE) > -1
                    ? true
                    : false
            case 'existences':
                return userPermissions.indexOf(PERMISSIONS.DETAILS_EXISTENCE) >
                    -1
                    ? true
                    : false
            default:
    ...
    const handleShowEditPermission = (type: string) => {
        switch (type) {
            case 'gi':
                return userPermissions.indexOf(PERMISSIONS.EDIT_GI) > -1
                    ? true
                    : false
            case 'employees':
                return userPermissions.indexOf(PERMISSIONS.EDIT_EMPLOYEE) > -1
                    ? true
                    : false
            case 'requests':
                return userPermissions.indexOf(PERMISSIONS.EDIT_REQUEST) > -1
                    ? true
                    : false
            case 'reservations':
                return userPermissions.indexOf(PERMISSIONS.EDIT_RESERVATION) >
                    -1
                    ? true
                    : false
            default:
    ...
    const handleShowNullifyPermission = (type: string) => {
        switch (type) {
            case 'requests':
                return userPermissions.indexOf(PERMISSIONS.NULLIFY_REQUEST) > -1
                    ? true
                    : false
            case 'reservations':
                return userPermissions.indexOf(
                    PERMISSIONS.NULLIFY_RESERVATION
                ) > -1
                    ? true
                    : false
            case 'evaluations':
                return userPermissions.indexOf(PERMISSIONS.NULLIFY_EVALUATION) >
                    -1
                    ? true
                    : false
            case 'results':
                return userPermissions.indexOf(PERMISSIONS.NULLIFY_RESULT) > -1
                    ? true
                    : false
            default:
                return false
    ...
    const handleShowSendMailTemplate = (type: string) => {
        switch (type) {
            case 'requests':
                return userPermissions.indexOf(
                    PERMISSIONS.SEND_MAIL_TEMPLATE_REQUEST
                ) > -1
                    ? true
                    : false
            case 'reservations':
                return userPermissions.indexOf(
                    PERMISSIONS.SEND_MAIL_TEMPLATE_RESERVATION
                ) > -1
                    ? true
                    : false
            default:
    ...
    const handleShowSendMail = (type: string) => {
        switch (type) {
            case 'results':
                return userPermissions.indexOf(PERMISSIONS.SEND_MAIL) > -1
                    ? true
                    : false
            default:
                return false
    ...
    const handleShowDownloadExam = (type: string) => {
        switch (type) {
            case 'evaluations':
                return userPermissions.indexOf(
                    PERMISSIONS.DOWNLOAD_EXAM_EVALUACION
                ) > -1
                    ? true
                    : false
            default:
    ...
    const handleShowConfirmExam = (type: string) => {
        switch (type) {
            case 'evaluations':
                return userPermissions.indexOf(
                    PERMISSIONS.CONFIRM_EXAM_EVALUATION
                ) > -1
                    ? true
                    : false
            default:
                  ...
                  render: (_: string, record: any) => (
                      <>
                          {record.estado_archivo === 'Sin Documento' && (
                              <Tag style={{ textAlign: 'center' }} color="grey">
                                  Sin Documento
                              </Tag>
                          )}
                ...
                <>
                    ...
                    {handleShowDetailsPermission(typeModule) && showDetails && (
                        <Tooltip title="Detalle" color={'#50ACF5'}>
                            <Button
                                onClick={() =>
                                    onClickAction('details', record._id)
                                }
                    ...
                    {handleShowEditPermission(typeModule) &&
                        showEdit &&
                        (record.estado === 'Ingresado' ||
                    ...
                    {userPermissions.indexOf(PERMISSIONS.ABSENSES_EMPLOYEE) >
                        -1 &&
                        showAbsence && (
                            <Tooltip title="Ausencias" color={'#4DE13E'}>
                                <Button
                                    onClick={() =>
                                        onClickAction('absense', record._id)
                                    }
                    ...
                    {handleShowNullifyPermission(typeModule) && showNullify && (
                        <Popover
                            ...
                            trigger="click"
                            visible={
                                deleteConfirmation._id === record._id &&
                    ...
                    {userPermissions.indexOf(PERMISSIONS.CONFIRM_REQUEST) >
                        -1 &&
                        showSchedule &&
                        record.estado === 'Ingresado' && (
                            <Tooltip title="Agendar" color={'#50ACF5'}>
                                <Button
                                    onClick={() =>
                                        onClickAction('schedule', record._id)
                                    }
                                    style={{ backgroundColor: '#50ACF5' }}
                                    icon={
                                        <CalendarOutlined
                    ...
                    {userPermissions.indexOf(PERMISSIONS.CONFIRM_RESERVATION) >
                        -1 &&
                        showReservation &&
                        record.estado === 'Ingresado' && (
                            <Tooltip title="Reservar" color={'#4CAF50'}>
                                <Button
                                    onClick={() =>
                                        onClickAction('reservation', record._id)
                                    }
                    ...
                    {userPermissions.indexOf(
                        PERMISSIONS.UPLOAD_EXAM_EVALUATION
                    ) > -1 &&
                        showUploadExam &&
                        record.estado === 'Ingresado' &&
                        (record.estado_archivo === 'Sin Documento' ||
                        ...
                        showFileState && (
                            <Tooltip title="Subir Examen" color={'#1073B5'}>
                                <Button
                                    onClick={() =>
                                        onClickAction('uploadexam', record._id)
                                    }
                    ...
                    {userPermissions.indexOf(
                        PERMISSIONS.GENERATE_EXAM_EVALUATION
                    ) > -1 &&
                        showGenerateExam &&
                        record.estado === 'Ingresado' &&
                        (record.estado_archivo === 'Sin Documento' ||
                    ...
                    {handleShowDownloadExam(typeModule) &&
                        showDownloadExam &&
                        record.estado === 'En Evaluacion' &&
                        record.estado_archivo === 'Cargado' &&
                        (record.nombre_servicio ===
                    ...
                    {handleShowConfirmExam(typeModule) &&
                        showConfirmExam &&
                        record.estado === 'En Evaluacion' &&
                        record.estado_archivo === 'Cargado' && (
                            <Tooltip title="Confirmar Examen" color={'#18BBC3'}>
                                <Button
                                    onClick={() =>
                                        onClickAction('confirmexam', record._id)
                                    }
                    ...
                    {userPermissions.indexOf(PERMISSIONS.UPLOAD_RESULT) > -1 &&
                        showUploadResult &&
                        record.estado === 'En Revisión' &&
                        (record.estado_archivo === 'Sin Documento' ||
                            record.estado_archivo === 'Rechazado') && (
                    ...
                    {userPermissions.indexOf(PERMISSIONS.DOWNLOAD_EXAM_RESULT) >
                        -1 &&
                        showDownloadResult &&
                        (record.estado === 'En Revisión' ||
                            record.estado === 'Revisado') &&
                    ...
                    {userPermissions.indexOf(PERMISSIONS.CONFIRM_RESULT) > -1 &&
                        showConfirmResult &&
                        record.estado === 'En Revisión' &&
                        record.estado_archivo === 'Cargado' && (
                            <Tooltip
                    ...
                    {userPermissions.indexOf(PERMISSIONS.UPLOAD_OC) > -1 &&
                        ...
                        record.oc === 'Si' && (
                            <Tooltip title="Subir OC" color={'#50ACF5'}>
                                <Button
                                    onClick={() =>
                                        onClickAction('uploadoc', record._id)
                                    }
                                    style={{ backgroundColor: '#50ACF5' }}
                                    icon={
                                        <FilePdfOutlined
                    ...
                    {userPermissions.indexOf(PERMISSIONS.CONFIRM_OC) > -1 &&
                        ...
                        record.estado_archivo === 'Cargado' && (
                            <Tooltip title="Confirmar OC" color={'#39AE16'}>
                                <Button
                                    onClick={() =>
                                        onClickAction('confirmoc', record._id)
                                    }
                    ...
                    {userPermissions.indexOf(PERMISSIONS.DOWNLOAD_OC) > -1 &&
                        showDownloadOc &&
                        record.estado === 'En Revisión' &&
                        record.estado_archivo === 'Cargado' && (
                            <Tooltip title="Descargar OC" color={'#1A9D02'}>
                                <Button
                                    onClick={() =>
                                        onClickAction('downloadoc', record._id)
                                    }
                                    style={{ backgroundColor: '#1A9D02' }}
                                    icon={
                                        <CloudDownloadOutlined
                    ...
                    {userPermissions.indexOf(PERMISSIONS.DOWNLOAD_INVOICE) >
                        -1 &&
                        showDownloadInvoice &&
                        record.estado === 'En Facturacion' &&
                        record.estado_archivo === 'Cargado' && (
                    ...
                    {userPermissions.indexOf(PERMISSIONS.SHOW_INVOICE) > -1 &&
                        showInvoice &&
                        record.estado === 'En Facturacion' &&
                        (record.estado_archivo === 'Sin Documento' ||
                            record.estado_archivo === 'Aprobado' ||
                    ...
                    {userPermissions.indexOf(PERMISSIONS.CONFIRM_INVOICE) >
                        -1 &&
                        showValidateInvoice &&
                        record.estado === 'En Facturacion' &&
                        record.estado_archivo === 'Cargado' && (
                    ...
                    {userPermissions.indexOf(PERMISSIONS.MANAGMENT_PAYMENT) >
                        -1 &&
                    ...
                    {userPermissions.indexOf(PERMISSIONS.GENERATE_PAYMENT) >
                        -1 &&
                        showGeneratePayment &&
                        record.estado !== 'Pagado' && (
                    ...
                    {userPermissions.indexOf(PERMISSIONS.CARD_REQUESTPAYMENT) >
                        -1 &&
                    ...
                    {userPermissions.indexOf(PERMISSIONS.DOWNLOAD_EXPENSE) >
                        -1 &&
                        ShowDownloadExpense && (
                    ...
                    {userPermissions.indexOf(PERMISSIONS.SHOW_ENTRIES) > -1 &&
                        ShowEntries &&
                        record.inventario === 'Si' && (
                            <Tooltip title="Entradas" color={'#55D515'}>
                                <Button
                                    onClick={() =>
                                        onClickAction('entries', record._id)
                                    }
                    ...
                    {handleShowSendMailTemplate(typeModule) &&
                        showSendMailTemplate &&
                        (record.codigo.includes('SOL') ||
                            (record.codigo.includes('AGE') &&
                                record.estado === 'Reservado')) && (
                            <Tooltip title="Enviar Mail" color={'#222DB7'}>
                                <Button
                                    onClick={() =>
                                        onClickAction('sendmail', record._id)
                                    }
    ...
    return (
        <Table
            ...
            style={
                useStyle
                    ? { width: '94%', marginTop: '10.7rem' }
                    : { width: '100%' }
            }
            rowKey={'key'}
            pagination={
                enablePagination ? { position: ['bottomCenter'] } : false
            }
        />
    )
}
