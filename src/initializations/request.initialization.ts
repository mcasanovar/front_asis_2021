...
export const RequestInitialization: RequestModel = {
    ...
    anio_solicitud: '',
    nombre_receptor:
        userLogged !== null ? JSON.parse(userLogged).gi.razon_social : '',
    categoria1: '',
    categoria2: '',
    categoria3: '',
    nombre_servicio: '',
    ...
    fecha_servicio_solicitado: moment().format(FORMAT_DATE),
    hora_servicio_solicitado: moment().format('HH:mm'),
    fecha_servicio_solicitado_termino: moment().format(FORMAT_DATE),
    hora_servicio_solicitado_termino: moment().format('HH:mm'),
    jornada: '',
    estado: 'Ingresado',
    isActive: true,
}
